...
|-------|---------|-------------|
| AI-Ready Jira | `/ai-ready-jira` | Interview-based ticket prep for Claude Code — takes a UW (or list of UWs) and systematically gathers scope, platforms, clear issue descriptions, and reproduction steps to accelerate the dev cycle |
